/* This file provides the definition of the struct AlgoIFOutput in the interface version ODA1_1.4.
   
   It also provides endianess-aware functions to safely convert a binary buffer to an 
   instance of this struct (if possible).
*/

#ifndef IFM_O3M_ALGOIFOUTPUT_ODA1_1_4_CONVERTER_H_INCLUDED
#define IFM_O3M_ALGOIFOUTPUT_ODA1_1_4_CONVERTER_H_INCLUDED
