...
{
    ifm_o3m_AlgoIFOutput_DIA1_1_4* res = (ifm_o3m_AlgoIFOutput_DIA1_1_4*)buffer;
    if( (!buffer) || (bufferSize != 19224) || (sizeof(ifm_o3m_AlgoIFOutput_DIA1_1_4) != 19224) )
    {
        return 0;
    }
